# === Input paths ===
setwd('/Users/cuijiajun/Desktop/others/tmphernan/2025_summerpaper_all/2025_summer_paperfig_m57/results/figureandtable/supptables/supptable2sum')
# === Input paths ===
cov_file <- "tailocin_coverage_summary.tsv"
bykmer_file <- "combined_HTF_oantigen_m57_h43.txt"
bylocal_file <- "final_h49_m57_HTFhaplotype_bylocalassembly.txt"
#cp all of them from results folders...
# === Read tables ===
...
na_espE2 <- c("p25.C11", "PL0139", "86.NOR_1911_S7", "27.ESP_1975","PL0087","PL0105")
...
# === Write output ===
write.table(merged_final, file = "Supptable2_h43_m53_HTF_tailocin.txt",
            sep = "\t", row.names = FALSE, quote = FALSE)

cat("[✔] Output saved to: Supptable2_h43_m53_HTF_tailocin.txt\n")
