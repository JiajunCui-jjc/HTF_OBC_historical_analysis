...
base_exclude <- c("HB0828", "HB0863", "PL0066","PL0108", "PL0203", "PL0258", "64.GBR_1933b_S36", "PL0065","PL0026","PL0027","PL0053")
...
#triangle:
# === New plot: Modern with triangle, both solid alpha ===
p_htf_timeline_shapes <- ggplot(
  dominant_df,
  aes(x = Year, y = Yjitter, color = LengthGroup, shape = IsolateType)
) +
  geom_point(size = 4, alpha = 1) +   # solid for both
  scale_color_manual(
    values = length_colors,
    breaks = c("1830","1383","1803","1245")
  ) +
  scale_shape_manual(
    values = c("Historical" = 16, "Modern" = 17)   # circle = hist, triangle = modern
  ) +
  facet_wrap(~IsolateType, scales = "free_x") +
  scale_x_continuous(
    breaks = c(1850, 1900, 1950, 2000, 2018),
...
# === Save figure ===
ggsave(
  "/Users/cuijiajun/Desktop/others/tmphernan/2025_summerpaper_all/2025_summer_paperfig_m57/results/step1_HTFhaplotypes/step1.2_HTF_bykmers/step4_additionalanalysis/step3_HTFfreq/step2_2_3_HTF_length_timeline_shapes.pdf",
  plot = p_htf_timeline_shapes,
  width = 20, height = 4
)