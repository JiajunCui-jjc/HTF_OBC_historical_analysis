...
Publicly available *P. syringae* genomes were downloaded from NCBI and filtered for assembly quality (find details here in Patricia's github: https://github.com/pgirardi/ps1524_tradeoffs):
