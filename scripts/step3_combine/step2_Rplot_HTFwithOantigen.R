...
# === Paths ===
modern_keep_file <- "/Users/cuijiajun/Desktop/others/tmphernan/2025_summerpaper_all/2025_summer_paperfig_m57/scripts/step3_combine/modern53_infig.txt"
file <- "/Users/cuijiajun/Desktop/others/tmphernan/2025_summerpaper_all/2025_summer_paperfig_m57/results/step3_combine/combined_HTF_oantigen_m57_h43.txt"

# === Load data ===
df <- fread(file)
modern_keep <- fread(modern_keep_file, header = FALSE)$V1

# Keep only: all historical except 64. + nonATUE5 and NA list
# Samples to remove entirely
remove_list <- c("HB0828", "HB0863", "PL0066", "PL0108", "PL0203", "PL0258", "64.GBR_1933b_S36", "PL0065","PL0026","PL0027","PL0053")
#NA in kmer HTF assignment: 
#64.GBR_1933b_S36	NA	NA	0	0	0	0	0	0
#PL0026	NA	NA	1	0	1	1	1	0	0	
#PL0027	NA	NA	1	1	1	1	1	0	0	
#PL0053	NA	NA	0	0	0	0	0	1	4740	
#PL0065	NA	NA	0	0	1	1	1	0	0	

#nonatue5HB0828 HB0863 PL0066 PL0108 PL0203 PL0258
#64.GBR_1933b_S36 conflict HTF assign...
#49-13=36
#NA 
# Keep:
#   - all historical samples (not starting with "p")
#   - exclude "64."
#   - include modern_keep list
#   - exclude anything in remove_list
df <- df[
  (( !grepl("^p", df$sample) & !grepl("^64\\.", df$sample) ) | df$sample %in% modern_keep) &
    !(df$sample %in% remove_list),
]
...
bad_espE2_samples <- c("86.NOR_1911_S7", "27.ESP_1975", "PL0139", "p25.C11","PL0087","PL0105")
#check basedepth PL0087 and PL0105 has 1-4 depth, some info but not sufficient to assemble
...
ht <- Heatmap(
  ...
  column_title = "HTF haplotype - O-antigen OBC genes presence/absence (m53 + h38)"
)
pdf("/Users/cuijiajun/Desktop/others/tmphernan/2025_summerpaper_all/2025_summer_paperfig_m57/results/step3_combine/mainfig_HTFoantigen_m53_h43_38/m53_h38_heatmap_sixgene_only_with_HTFanno.pdf",
...
mh_colors <- c(
  ...
  Historical = "#a6631b"  ) # Earthy orange
...
pdf("/Users/cuijiajun/Desktop/others/tmphernan/2025_summerpaper_all/2025_summer_paperfig_m57/results/step3_combine/mainfig_HTFoantigen_m53_h43_38/mh_colorbar.pdf",
