...
bam=/SAN/ugi/plant_genom/jiajucui/4_mapping_to_pseudomonas/tailocin_2024_TF_Tapemeasure/2025_summer_paperfig_m57/data/all_fastq_h49/At_bams_h49_dedup/softlinkh49_At_dedup/${samplename}_mapped_At_q20.markdup.sorted.bam
mapDamage -i $bam -r ${refAt} --merge-libraries
