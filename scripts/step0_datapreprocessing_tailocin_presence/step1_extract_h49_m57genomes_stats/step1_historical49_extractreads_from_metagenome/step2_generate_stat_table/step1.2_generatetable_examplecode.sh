...
cd  /SAN/ugi/plant_genom/jiajucui/answer2025_maptoOTU5_nohaplotype_h49/
...
res2=`echo "scale=5; $Ps/$all" | bc`
#ps prop is ps/total instead of ps/atunmapped
nonannotated=$(($unmapped-$Ps))
res3=`echo "scale=5; $nonannotated/$all" | bc`

allPs=$(cat answers_for_${samplename}.txt | grep 'q4 What' -A 4 | grep '5954076')
