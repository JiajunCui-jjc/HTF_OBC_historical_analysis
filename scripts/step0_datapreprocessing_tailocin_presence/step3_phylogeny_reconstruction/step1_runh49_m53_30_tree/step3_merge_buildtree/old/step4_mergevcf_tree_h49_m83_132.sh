...
#$ -hold_jid h49_callvcf,m30_callvcf,m53_callvcf,m55_callvcf
...
python /SAN/ugi/plant_genom/jiajucui/phylogeny/phylogeny_snp/vcf2phylip/vcf2phylip.py \
    -i bialleliconly_h49_m83_132samples.vcf.gz -m 132

mv bialleliconly_h49_m83_132samples.min132.phy "${TREE_DIR}/"

cd "${TREE_DIR}"
echo "[INFO] Running IQ-TREE..."
iqtree -T AUTO \
    -s bialleliconly_h49_m83_132samples.min132.phy \
