...
#$ -t 1-30   # adjust to your total number of samples
...
# ---- Paths ----
WD="/SAN/ugi/plant_genom/jiajucui/4_mapping_to_pseudomonas/tailocin_2024_TF_Tapemeasure/2025_summer_paperfig_m57/data/all_fastq_m30_nonATUE5"
OUTDIR="${WD}/all_bams_m30"
...
# ---- Output files ----
BAM_FINAL="${OUTDIR}/${SAMPLE}_mapped_Ps_q20.sorted.bam"
...
samtools sort -@ 2 -o "${BAM_FINAL}" "${OUTDIR}/tmp/${SAMPLE}.filtered.bam"
