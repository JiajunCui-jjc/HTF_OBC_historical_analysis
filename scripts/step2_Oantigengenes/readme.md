...
- In **steps 3–6**, we calculated:
  ...
  [See summary table](/results/step2_Oantigengenes/historical49_modern57_bybamcov/final_cov_depth_wide_cat.tsv)
...
Genes not meeting both thresholds were scored as **absent**. [The final result is a **binary gene presence/absence matrix** across isolates.](/results/step2_Oantigengenes/historical49_modern57_bybamcov/final_fivegenes_binary_matrix.tsv)
...
- For [**modern isolates**](/scripts/step2_Oantigengenes/checkespE2_contigs/session2_retrieve_espE2_minimap):
  ...
  - This yielded a diverse set of modern *espE2* haplotypes.[See msa with 18 empty and 39 retrieved seqs.](/results/step2_Oantigengenes/espE2_rescue/checkespE2_57m/final_afterexpasy/completeopenframe.39fasta.txt)

- For [**historical isolates**](/scripts/step2_Oantigengenes/checkespE2_contigs/session3_fish_historical) (which lack assemblies):
  - The above [**modern haplotype set**](/results/step2_Oantigengenes/espE2_rescue/checkespE2_57m/final_afterexpasy/completeopenframe.39fasta.txt) was used as an expanded reference.
  - Reads mapping to any haplotype were extracted and **locally assembled** with **SPAdes**.
  - Contigs were then aligned back to the haplotype reference with **Minimap2** to identify the best-matching allele. [See summary binary table including espE2_rescued here](/results/step2_Oantigengenes/espE2_rescue/fish_historical/final_sixgenes_withm57_h49_epsE2rescued_binary_matrix.tsv)
...
- For **both modern and historical** datasets:
  ...
  - Final multiple sequence alignments and allele length distributions are provided [here](/results/figureandtable/supptables/supptable2sum/Supptable2_h43_m53_HTF_tailocin.txt).
